...
export const Items = [
    {
        id: 1,
        category: 'product',
        productName: 'MI Super Bass Bluetooth Wireless Headhones',
        productPrice: 200000,
        description:
        'Up to 20 hours battery life | Super powerful Bass | 40mm dynamic driver | Pressuer less muffs | Bluetooth 5.0 | Voice control',
        isOff: true,
        offPercentage: 10,
    ...
    },
    {
        ...
        productPrice: 150000,
        description:
        'boAt Rockerz 450 M is on-ear wireless headset that has been ergonomically designed to meet the needs of music lovers.',
        isOff: false,
    ...
    },
    {
        id: 3,
        category: 'accessory',
        productName: 'boAt Airdropes 441',
        productPrice: 100000,
        description:
